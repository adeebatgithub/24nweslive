...
<section class="pb-4">
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-12 editor-pick">
...
<section class="pb-2">
    <div id="13" class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                    <div id="carouselExampleCaptions" class="carousel slide top-news-1" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                ...
                                <h5 class="news-title news-title-lg mb-2">{{ $item->post_title }}</h5>
                                <p>{!! \Illuminate\Support\Str::words(strip_tags($item->post_detail), 55, '...') !!}</p>
                                <br>
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="col-lg-6 top-new-list">
                @foreach($post_13days_data as $key => $item)
                @if($key < 10) {{-- Skip items before the 9th --}}
                    @continue
                    @elseif($key> 15) {{-- Break after the 15th item --}}
                    @break
                    @endif
                    ...
                    <div class="col-lg-6 mb-4 mb-xl-0 best-christian-1">
                        ...
                        <div class="page-news-box">
                            ...
                            <a href="{{ route('news_detail',$slug) }}">
                                ...
                                <p>{!! strip_tags(\Illuminate\Support\Str::words($single->post_detail, 50,'...')) !!}</p>
                            </a>
                        </div>
                        <!-- <div class="col-lg-3 mb-4 add-width-1 text-center">
                            <a href="#">
...
<section class="pb-4 ">
    <div id="Obituary" class="container">
        ...
        <div class="row live-talk">
            <div id="LiveTalk" class="col-lg-12">
