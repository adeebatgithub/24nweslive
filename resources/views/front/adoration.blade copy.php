...
<style>
/* Video container with standard 16:9 aspect ratio */
...
.responsive-chat-container {
  position: relative;
  width: 100%;
  padding-bottom: 168.5%; /* 112.5% makes it double the height */
  overflow: hidden;
}

.responsive-video-container iframe,
.responsive-chat-container iframe {
          ...
          <div class="col-12">
            <div class="page-news-box">
              <div class="d-flex flex-column flex-sm-row justify-content-between  news-date">
                ...
                <!-- Button trigger modal -->
                <div>
                  <a class='wp-share' href='https://chat.whatsapp.com/LN1DtoTJK7r8DxzBrggM9A' target="_blank">
                    Join On Prayer Group</a>
                </div>
                <br />
                <!-- Button trigger modal -->
              ...
              <div class="responsive-video-container"><iframe width="876" height="500" src="https://www.youtube.com/embed/{{ $post_detail->video_link  }}?autoplay=1" allow="autoplay"></iframe></div>
              <br />
