...
<head>
    <meta charset="utf-8">
    <title>@yield('title','Breaking News and Malayalam Updates | 24NewsLive')</title>
    <meta name="keywords" content="@yield('meta_keywords','24, 24x7, 24newslive, Malayalam News, Breaking News')">
    <meta name="description" content="@yield('meta_description','Stay updated with the latest breaking news and Malayalam updates on 24NewsLive. Comprehensive coverage of news 24x7.')">
    <meta property="og:image" content="@yield('og:image','https://24newslive.com/uploads/24newslivelogo3.webp')" />
...
<body class="copy-content-lock">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-10 header-add mt-3 mt-md-0">
                    <div class="row">
                        ...
                        @endif
                        @if($global_top_ad_data->top_ad1_status == 'Show')
                        <div class="col-sm-6">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-lg-4 mb-4">
                            <h4>Prayer Groups Links</h4>
                            <ul>
                                <li><a href="https://chat.whatsapp.com/Jvk68BMg0vy7l2TcV26vKx" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">0</span></a></li>
                                <li><a href="{{ route('home') }}#Kerala" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">1</span></a></li>
                                <li><a href="{{ route('home') }}#Religion" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">2</span></a></li>
                                <li><a href="{{ route('home') }}#Special" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">3</span></a></li>
                                <li><a href="{{ route('home') }}#Trending" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">4</span></a></li>
                                <li><a href="{{ route('home') }}#US" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">5</span></a></li>
                                <li><a href="{{ route('home') }}#India" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">6</span></a></li>
                                <li><a href="{{ route('volunteer') }}" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">7</span></a></li>
                                <li><a href="{{ route('testimonials') }}" class="d-flex align-items-center">WA Group<span
                                            class="ps-2 ms-auto">8</span></a></li>
                            </ul>
                        ...
                        <div class="col-sm-4 col-lg-2 mb-4">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('home') }}#India" class="d-flex align-items-center">India<span
                                            class="ps-2 ms-auto">6</span></a></li>
                                <li><a href="{{ route('volunteer') }}" class="d-flex align-items-center">Volunteers<span
                                            class="ps-2 ms-auto">7</span></a></li>
                                <li><a href="{{ route('testimonials') }}" class="d-flex align-items-center">Testimonials<span
                                            class="ps-2 ms-auto">8</span></a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- <div class="fixed-add left-add text-center">
        <a href="#" class="d-inline-block">
            @if (isset($global_sidebar_StickyAd1->sidebar_ad))
            <img src="{{ asset('uploads/'.$global_sidebar_StickyAd1->sidebar_ad) }}" class="w-100" alt="">
            @endif
        </a>
    </div>
    <div class="fixed-add right-add text-center">
        <a href="#" class="d-inline-block">
            @if (isset($global_sidebar_StickyAd2->sidebar_ad))
            <img src="{{ asset('uploads/'.$global_sidebar_StickyAd2->sidebar_ad) }}" class="w-100" alt="">
            @endif
        </a>
    </div> -->
