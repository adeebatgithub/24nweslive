            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 pe-xl-4">
                        ...
                        <div class="banner-news position-relative mb-3 overflow-hidden">
                            <a href="{{ route('news_detail',$slug) }}"><img src="{{ asset('uploads/'.$item->post_photo) }}" class="w-100" alt="">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <ul class="m-0 p-0">
                                    @foreach($item as $single)
                                    <li>
                                        <a href="http://www.youtube.com/watch?v={{ $single->video_id }}" class="video-button"> <img src="http://img.youtube.com/vi/{{ $single->video_id }}/0.jpg" class="img-fluid pe-4" alt="">
            ...
            <div class="container">
                <div class="row ">
                    <div class="col-lg-3 mb-4 add-width-1 text-center">
                        <a href="#"><img src="{{ asset('uploads/'.$global_sidebar_ad1->sidebar_ad) }}" class="w-100" alt=""></a>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            @foreach($sub_category_data as $item)
                                                ...
                                                @continue
                                                @endif
                                                @if($item->sub_category_name == "13 DAYS BIBLE READING")
                                                @foreach($item->rPost as $single)
                                                @if($loop->iteration == 3)
                                                @break
                                                @endif
                        ...
                        $slug = (isset($single->slug)) ? $single->slug : $single->id;
                                ...
                                <a href="{{ route('news_detail',$slug) }}">
                                        ...
                                        <h5 class="news-title news-title-lg mb-2">{{ $single->post_title }}</h5>
                                        <p>{!! \Illuminate\Support\Str::words($single->post_detail, 40,'...') !!}</p>
                            ...
                            <div class="news-box">
                               @php
                                ...
                                <a href="{{ route('news_detail',$slug) }}">
                                    ...
                                    <p>{!! strip_tags(\Illuminate\Support\Str::words($single->post_detail, 30,'...')) !!}</p>
                                </a>
                            </div>
                            <!-- <div class="col-lg-3 mb-4 add-width-1 text-center">
                            <a href="#"><img src="{{ asset('uploads/'.$global_sidebar_ad3->sidebar_ad) }}" class="w-100" alt=""></a>
                            </div> -->
                            @endforeach
                            @endif
                            @endforeach
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 add-width-1 text-center mb-4 mb-xl-0">
                        <a href="#"><img src="{{ asset('uploads/'.$global_sidebar_ad2->sidebar_ad) }}" class="w-100" alt=""></a>
                    </div>
...
$slug = (isset($item->slug)) ? $single->slug : $single->id;
                    ...
                    <div class="col-lg-3 mb-4 add-width-1 text-center">
                        <a href="#"><img src="{{ asset('uploads/'.$global_sidebar_ad4->sidebar_ad) }}" class="w-100" alt=""></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-4 mb-md-0">
