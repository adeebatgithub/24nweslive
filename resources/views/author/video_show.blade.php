...
@section('button')
<a href="{{ route('author_video_create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('author_video_edit',$row->id) }}" class="btn btn-primary">Edit</a>
                                        <a href="{{ route('author_video_delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
