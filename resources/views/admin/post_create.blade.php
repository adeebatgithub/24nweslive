                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="post_title_english" type="text" class="form-control" name="post_title_english" value="">
                        </div>
                        <div class="form-group mb-3">
                            <label>Slug</label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="video_link" type="text" class="form-control" name="video_link" value="">
                        </div>
                        <div class="form-group mb-3">
