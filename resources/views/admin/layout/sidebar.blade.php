<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/volunteer/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_volunteer_show') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Online Poll"><i class="fas fa-vote-yea"></i> <span>Volunteer</span></a></li>

            <li class="{{ Request::is('admin/testimonials/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_testimonials_show') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Online Poll"><i class="fas fa-vote-yea"></i> <span>Testimonials</span></a></li>
