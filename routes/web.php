...
use App\Http\Controllers\Front\LiveChannelController;
...
use App\Http\Controllers\Front\PrayerRequestController;
use App\Http\Controllers\Front\CountryStateCityController;
...
use App\Http\Controllers\Author\AuthorPhotoController;
use App\Http\Controllers\Author\AuthorVideoController;
use App\Http\Controllers\Front\AdorationController;
...
Route::get('/live_channel', [LiveChannelController::class, 'index'])->name('live_channel');
...
Route::get('/adoration', [AdorationController::class, 'detail'])->name('adoration');
Route::post('/google-chat-webhook', [ChatController::class, 'handleWebhook']);
...
Route::get('/author/photo/show', [AuthorPhotoController::class, 'show'])->name('author_photo_show')->middleware('author:author');
Route::get('/author/photo/create', [AuthorPhotoController::class, 'create'])->name('author_photo_create')->middleware('author:author');
Route::post('/author/photo/store', [AuthorPhotoController::class, 'store'])->name('author_photo_store');
Route::get('/author/photo/edit/{id}', [AuthorPhotoController::class, 'edit'])->name('author_photo_edit')->middleware('author:author');
Route::post('/author/photo/update/{id}', [AuthorPhotoController::class, 'update'])->name('author_photo_update');
Route::get('/author/photo/delete/{id}', [AuthorPhotoController::class, 'delete'])->name('author_photo_delete')->middleware('author:author');


Route::get('/author/video/show', [AuthorVideoController::class, 'show'])->name('author_video_show')->middleware('author:author');
Route::get('/author/video/create', [AuthorVideoController::class, 'create'])->name('author_video_create')->middleware('author:author');
Route::post('/author/video/store', [AuthorVideoController::class, 'store'])->name('author_video_store');
Route::get('/author/video/edit/{id}', [AuthorVideoController::class, 'edit'])->name('author_video_edit')->middleware('author:author');
Route::post('/author/video/update/{id}', [AuthorVideoController::class, 'update'])->name('author_video_update');
Route::get('/author/video/delete/{id}', [AuthorVideoController::class, 'delete'])->name('author_video_delete')->middleware('author:author');
...
Route::get('/admin/volunteer/show', [AdminVolunteerController::class, 'show'])->name('admin_volunteer_show')->middleware('admin:admin');
Route::get('/admin/volunteer/create', [AdminVolunteerController::class, 'create'])->name('admin_volunteer_create')->middleware('admin:admin');
Route::post('/admin/volunteer/store', [AdminVolunteerController::class, 'store'])->name('admin_volunteer_store');
Route::get('/admin/volunteer/edit/{id}', [AdminVolunteerController::class, 'edit'])->name('admin_volunteer_edit')->middleware('admin:admin');
Route::post('/admin/volunteer/update/{id}', [AdminVolunteerController::class, 'update'])->name('admin_volunteer_update');
Route::get('/admin/volunteer/delete/{id}', [AdminVolunteerController::class, 'delete'])->name('admin_volunteer_delete')->middleware('admin:admin');

Route::get('/volunteer', [VolunteerController::class, 'index'])->name('volunteer');
Route::post('/volunteer', [VolunteerController::class, 'submit'])->name('volunteer_submit');

Route::get('/testimonials', [TestimonialsController::class, 'index'])->name('testimonials');
Route::post('/testimonials', [TestimonialsController::class, 'submit'])->name('testimonials_submit');


Route::get('/admin/testimonials/show', [AdminTestimonialsController::class, 'show'])->name('admin_testimonials_show')->middleware('admin:admin');
Route::get('/admin/testimonials/create', [AdminTestimonialsController::class, 'create'])->name('admin_testimonials_create')->middleware('admin:admin');
Route::post('/admin/testimonials/store', [AdminTestimonialsController::class, 'store'])->name('admin_testimonials_store');
Route::get('/admin/testimonials/edit/{id}', [AdminTestimonialsController::class, 'edit'])->name('admin_testimonials_edit')->middleware('admin:admin');
Route::post('/admin/testimonials/update/{id}', [AdminTestimonialsController::class, 'update'])->name('admin_testimonials_update');
Route::get('/admin/testimonials/delete/{id}', [AdminTestimonialsController::class, 'delete'])->name('admin_testimonials_delete')->middleware('admin:admin');
Route::get('/admin/testimonials/tag/delete/{id}/{id1}', [AdminTestimonialsController::class, 'delete_tag'])->name('admin_testimonials_delete_tag')->middleware('admin:admin');
